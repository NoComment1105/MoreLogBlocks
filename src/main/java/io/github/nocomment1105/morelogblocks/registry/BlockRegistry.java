...
public class BlockRegistry {
    ...
    public static final Block OAK_LOG_SLAB = new SlabBlock(FabricBlockSettings.of(
            Material.WOOD, MapColor.OAK_TAN).breakByTool(FabricToolTags.AXES, 0).requiresTool().strength(2.0f)
    ...
    public static final Block SPRUCE_LOG_SLAB = new SlabBlock(FabricBlockSettings.of(
            Material.WOOD, MapColor.SPRUCE_BROWN).breakByTool(FabricToolTags.AXES, 0).requiresTool().strength(2.0f)
            .sounds(BlockSoundGroup.WOOD));
    ...
    public static final Block BIRCH_LOG_SLAB = new SlabBlock(FabricBlockSettings.of(
            Material.WOOD, MapColor.PALE_YELLOW).breakByTool(FabricToolTags.AXES, 0).requiresTool().strength(2.0f)
            .sounds(BlockSoundGroup.WOOD));
    ...
    public static final Block JUNGLE_LOG_SLAB = new SlabBlock(FabricBlockSettings.of(
            Material.WOOD, MapColor.DIRT_BROWN).breakByTool(FabricToolTags.AXES, 0).requiresTool().strength(2.0f)
            .sounds(BlockSoundGroup.WOOD));
    ...
    public static final Block ACACIA_LOG_SLAB = new SlabBlock(FabricBlockSettings.of(
            Material.WOOD, MapColor.ORANGE).breakByTool(FabricToolTags.AXES, 0).requiresTool().strength(2.0f)
            .sounds(BlockSoundGroup.WOOD));
    ...
    public static final Block DARK_OAK_LOG_SLAB = new SlabBlock(FabricBlockSettings.of(
            Material.WOOD, MapColor.BROWN).breakByTool(FabricToolTags.AXES, 0).requiresTool().strength(2.0f)
            .sounds(BlockSoundGroup.WOOD));
    ...
    public static final Block CRIMSON_STEM_STAIRS = new MoreLogStairBlock(
            ...
            .requiresTool().strength(2.0f).sounds(BlockSoundGroup.NETHER_STEM));
    public static final Block CRIMSON_STEM_SLAB = new SlabBlock(FabricBlockSettings.of(
            Material.NETHER_WOOD, MapColor.DULL_PINK).breakByTool(FabricToolTags.AXES, 0).requiresTool().strength(2.0f)
    ...
    public static final Block WARPED_STEM_SLAB = new SlabBlock(FabricBlockSettings.of(
            Material.NETHER_WOOD, MapColor.DARK_AQUA).breakByTool(FabricToolTags.AXES, 0).requiresTool().strength(2.0f)
            .sounds(BlockSoundGroup.NETHER_STEM));
    ...
    public static final Block ACACIA_WOOD_SLAB = new SlabBlock(FabricBlockSettings.of(
                    Material.WOOD, MapColor.GRAY).breakByTool(FabricToolTags.AXES, 0).requiresTool().strength(2.0f)
            .sounds(BlockSoundGroup.WOOD));
    ...
    public static final Block CRIMSON_HYPHAE_SLAB = new SlabBlock(FabricBlockSettings.of(
                    Material.NETHER_WOOD, MapColor.DARK_CRIMSON).breakByTool(FabricToolTags.AXES, 0).requiresTool().strength(2.0f)
            .sounds(BlockSoundGroup.NETHER_STEM));
    ...
    public static final Block WARPED_HYPHAE_SLAB = new SlabBlock(FabricBlockSettings.of(
                    Material.NETHER_WOOD, MapColor.DARK_DULL_PINK).breakByTool(FabricToolTags.AXES, 0).requiresTool().strength(2.0f)
            .sounds(BlockSoundGroup.NETHER_STEM));
