...
public class BlockRegistry {
    ...
    public static void registerBlocks() {
        registerBlock("oak_log_stairs", OAK_LOG_STAIRS);
        registerBlock("oak_log_slab", OAK_LOG_SLAB);
        registerBlock("spruce_log_stairs", SPRUCE_LOG_STAIRS);
        registerBlock("spruce_log_slab", SPRUCE_LOG_SLAB);
        registerBlock("birch_log_stairs", BIRCH_LOG_STAIRS);
        registerBlock("birch_log_slab", BIRCH_LOG_SLAB);
        registerBlock("jungle_log_stairs", JUNGLE_LOG_STAIRS);
        registerBlock("jungle_log_slab", JUNGLE_LOG_SLAB);
        registerBlock("acacia_log_stairs", ACACIA_LOG_STAIRS);
        registerBlock("acacia_log_slab", ACACIA_LOG_SLAB);
        registerBlock("dark_oak_log_stairs", DARK_OAK_LOG_STAIRS);
        registerBlock("dark_oak_log_slab", DARK_OAK_LOG_SLAB);
        registerBlock("crimson_stem_stairs", CRIMSON_STEM_STAIRS);
        registerBlock("crimson_stem_slab", CRIMSON_STEM_SLAB);
        registerBlock("warped_stem_stairs", WARPED_STEM_STAIRS);
        registerBlock("warped_stem_slab", WARPED_STEM_SLAB);

        registerBlock("oak_wood_stairs", OAK_WOOD_STAIRS);
        registerBlock("oak_wood_slab", OAK_WOOD_SLAB);
        registerBlock("spruce_wood_stairs", SPRUCE_WOOD_STAIRS);
        registerBlock("spruce_wood_slab", SPRUCE_WOOD_SLAB);
        registerBlock("birch_wood_stairs", BIRCH_WOOD_STAIRS);
        registerBlock("birch_wood_slab", BIRCH_WOOD_SLAB);
        registerBlock("jungle_wood_stairs", JUNGLE_WOOD_STAIRS);
        registerBlock("jungle_wood_slab", JUNGLE_WOOD_SLAB);
        registerBlock("acacia_wood_stairs", ACACIA_WOOD_STAIRS);
        registerBlock("acacia_wood_slab", ACACIA_WOOD_SLAB);
        registerBlock("dark_oak_wood_stairs", DARK_OAK_WOOD_STAIRS);
        registerBlock("dark_oak_wood_slab", DARK_OAK_WOOD_SLAB);
        registerBlock("crimson_hyphae_stairs", CRIMSON_HYPHAE_STAIRS);
        registerBlock("crimson_hyphae_slab", CRIMSON_HYPHAE_SLAB);
        registerBlock("warped_hyphae_stairs", WARPED_HYPHAE_STAIRS);
        registerBlock("warped_hyphae_slab", WARPED_HYPHAE_SLAB);

        registerBlock("stripped_oak_log_stairs", STRIPPED_OAK_LOG_STAIRS);
        registerBlock("stripped_oak_log_slab", STRIPPED_OAK_LOG_SLAB);
        registerBlock("stripped_spruce_log_stairs", STRIPPED_SPRUCE_LOG_STAIRS);
        registerBlock("stripped_spruce_log_slab", STRIPPED_SPRUCE_LOG_SLAB);
        registerBlock("stripped_birch_log_stairs", STRIPPED_BIRCH_LOG_STAIRS);
        registerBlock("stripped_birch_log_slab", STRIPPED_BIRCH_LOG_SLAB);
        registerBlock("stripped_jungle_log_stairs", STRIPPED_JUNGLE_LOG_STAIRS);
        registerBlock("stripped_jungle_log_slab", STRIPPED_JUNGLE_LOG_SLAB);
        registerBlock("stripped_acacia_log_stairs", STRIPPED_ACACIA_LOG_STAIRS);
        registerBlock("stripped_acacia_log_slab", STRIPPED_ACACIA_LOG_SLAB);
        registerBlock("stripped_dark_oak_log_stairs", STRIPPED_DARK_OAK_LOG_STAIRS);
        registerBlock("stripped_dark_oak_log_slab", STRIPPED_DARK_OAK_LOG_SLAB);
        registerBlock("stripped_crimson_stem_stairs", STRIPPED_CRIMSON_STEM_STAIRS);
        registerBlock("stripped_crimson_stem_slab", STRIPPED_CRIMSON_STEM_SLAB);
        registerBlock("stripped_warped_stem_stairs", STRIPPED_WARPED_STEM_STAIRS);
        registerBlock("stripped_warped_stem_slab", STRIPPED_WARPED_STEM_SLAB);

        registerBlock("stripped_oak_wood_stairs", STRIPPED_OAK_WOOD_STAIRS);
        registerBlock("stripped_oak_wood_slab", STRIPPED_OAK_WOOD_SLAB);
        registerBlock("stripped_spruce_wood_stairs", STRIPPED_SPRUCE_WOOD_STAIRS);
        registerBlock("stripped_spruce_wood_slab", STRIPPED_SPRUCE_WOOD_SLAB);
        registerBlock("stripped_birch_wood_stairs", STRIPPED_BIRCH_WOOD_STAIRS);
        registerBlock("stripped_birch_wood_slab", STRIPPED_BIRCH_WOOD_SLAB);
        registerBlock("stripped_jungle_wood_stairs", STRIPPED_JUNGLE_WOOD_STAIRS);
        registerBlock("stripped_jungle_wood_slab", STRIPPED_JUNGLE_WOOD_SLAB);
        registerBlock("stripped_acacia_wood_stairs", STRIPPED_ACACIA_WOOD_STAIRS);
        registerBlock("stripped_acacia_wood_slab", STRIPPED_ACACIA_WOOD_SLAB);
        registerBlock("stripped_dark_oak_wood_stairs", STRIPPED_DARK_OAK_WOOD_STAIRS);
        registerBlock("stripped_dark_oak_wood_slab", STRIPPED_DARK_OAK_WOOD_SLAB);
        registerBlock("stripped_crimson_hyphae_stairs", STRIPPED_CRIMSON_HYPHAE_STAIRS);
        registerBlock("stripped_crimson_hyphae_slab", STRIPPED_CRIMSON_HYPHAE_SLAB);
        registerBlock("stripped_warped_hyphae_stairs", STRIPPED_WARPED_HYPHAE_STAIRS);
        registerBlock("stripped_warped_hyphae_slab", STRIPPED_WARPED_HYPHAE_SLAB);
    }
